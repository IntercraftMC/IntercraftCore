...
public class ContainerScreenItemItemStack extends ContainerScreen<ContainerItemItemStack>
{
    ...
    public ContainerScreenItemItemStack(ContainerItemItemStack container, PlayerInventory playerInventory, ITextComponent name)
    {
