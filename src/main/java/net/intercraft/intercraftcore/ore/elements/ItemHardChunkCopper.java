...
public class ItemHardChunkCopper extends ItemHardChunk
{
    ...
    {
        super(new Item.Properties().group(IntercraftItemGroups.RESOURCES),ElementDictionary.COPPER.getSymbol(),ElementDictionary.COPPER.getColorSecondary(),new ElementComposition[] {
                new ElementComposition(ElementDictionary.COPPER,0.95),
